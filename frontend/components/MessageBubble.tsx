  ...
  return (
    <div
      className={`w-full py-6 ${
        isUser ? "bg-[var(--neutral)]" : "bg-[var(--background)]"
      ...
      <div className="max-w-3xl mx-auto px-4 flex items-start gap-4">
        ...
        <div className="prose prose-sm max-w-none flex-1">
          {isUser ? (
            ...
            <div className="whitespace-pre-wrap text-[var(--foreground)] bg-white p-4 rounded-lg border border-[var(--border-color)] shadow-sm">
